...
describe('GET /api/images', () => {
  ...
  it('should return 400 when called with a missing FILENAME', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const response = yield request.get('/api/images?height=200&width=200');
      expect(response.status).toBe(400);
      expect(response.text).toBe('filename is missing!!!');
    }));
  it('should return 400 when called with a missing WIDTH parameter', () =>
    __awaiter(void 0, void 0, void 0, function* () {
  ...
  it('should return 400 when called with a missing HEIGHT parameter', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const response = yield request.get(
  ...
  it('should return 404 when called correctly but FILENAME does not exist', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const response = yield request.get(
  ...
  it('should return 400 when called with WIDTH is invalid', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const response = yield request.get(
  ...
  it('should return 400 when called with HEIGHT is invalid', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const response = yield request.get(
  ...
  it('should return 200 if called correctly and image exist', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const response = yield request.get(
  ...
  it('should created a thumb version of the image', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      request
  ...
  it('should created a thumb version of the image', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      request
        ...
        .then(() => {
          const dimensions = (0, image_size_1.default)(
            path_1.default.resolve(
              __dirname,
