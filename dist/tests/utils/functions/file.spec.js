...
describe('utils/funtions - file.ts', () => {
    it('getImagePath - should return exactly path when input file name', () => {
        ...
        expect((0, file_1.getImagePath)(image)).toEqual(path_1.default.resolve(__dirname, '../../../../assets/images/full/test.jpg'));
    });
    it('resize - should return exactly path when input file name', () => __awaiter(void 0, void 0, void 0, function* () {
        const imageInfo = {
