...
describe('utils/funtions - validation.ts', () => {
  it('should return null when all parameters is correctly', async () => {
    const image = {
  ...
  it('should return 404 error when filename is not exists', async () => {
    const image = {
      filename: 'test',
      height: '100',
      width: '100',
  ...
  it('should return error when height is not a number', async () => {
    const image = {
      filename: 'santamonica',
      height: 'test',
      width: '100',
  ...
  it('should return error when width is not a number', async () => {
    const image = {
      filename: 'santamonica',
      height: '100',
      width: 'test',
